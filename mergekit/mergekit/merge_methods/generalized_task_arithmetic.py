...
class AdditiveMerge(MergeMethod, BaseModel, frozen=True):
...
class ApplyTaskVectors(Task[torch.Tensor]):
    ...
    def execute(
        ...
        **_kwargs,
        ...
        if self.method.sparsification_method:
            ...
            return mixed_delta.to(base.dtype)
