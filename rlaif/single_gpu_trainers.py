...
class FSDPTrainer(BasicTrainer):
    ...
    def save(self, output_dir=None, metrics=None, run_alpaca_eval: bool = False):
        ...
        # if you get any OOM errors here, change this line https://github.com/pytorch/pytorch/blob/main/torch/distributed/fsdp/_state_dict_utils.py#L345 
        # to this: "state_dict[fqn] = state_dict[fqn].cpu().clone().detach()"
        with FSDP.state_dict_type(self.policy, StateDictType.FULL_STATE_DICT, state_dict_config=save_policy):
            ...
            del policy_state_dict
        # dist.barrier()
        # there is no optimizer for single gpu so there's no point in saving this...